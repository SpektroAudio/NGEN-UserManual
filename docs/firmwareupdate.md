...
1 - [Download the latest version of the NGEN firmware for HW v1.1](https://dnjnjjoz9zg1x.cloudfront.net/firmware/NGEN_FWUpdate_v146_hw11.zip).
...
??? "Firmware Archive for NGEN HW v1.1+"       
      - [1.4.5 Update for NGEN HW v1.1](https://dnjnjjoz9zg1x.cloudfront.net/firmware/NGEN_FWUpdate_v145_hw11.zip)
...
1 - [Download the latest version of the NGEN firmware for HW v1.0](https://dnjnjjoz9zg1x.cloudfront.net/firmware/NGEN_FWUpdate_v146_hw10.zip)
...
??? "Firmware Archive for NGEN HW v1.0" 
      - [1.4.5 Update for NGEN HW v1.0](https://dnjnjjoz9zg1x.cloudfront.net/firmware/NGEN_FWUpdate_v145_hw10.zip)      
...
#### Fixed 
- [PROJECTS](projects.md): Fixed bug that could cause the display to freeze when saving projects
...
- [TRACK](track.md): Fixed bug that caused inactive tracks to play notes when Track Source was set to a specific clock generator
- Disabled leftover debug information
